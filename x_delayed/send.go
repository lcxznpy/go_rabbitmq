...
func NewRabbitMQXDelay(exchangeName, routingKey string) *Rabbit {
...
func (r Rabbit) ConsumeXDelay() {
	...
	go func() {
		for delivery := range msgs {
			...
			fmt.Println(t, "      Received a message:", string(delivery.Body))
		}
	}()
...
func (r Rabbit) PublishWithTTL(msg, ttl string) {
